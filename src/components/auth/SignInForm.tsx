...
// The validation error should allow 'message' for general API errors
interface ErrorState {
  email?: string;
  password?: string;
  message?: string; // To handle general API errors
}
...
export default function SignInForm() {
  ...
  // Use a proper email regex, not a 10-digit number regex
        ...
        <div>
          ...
          <div>
            ...
            <form onSubmit={(e) => e.preventDefault()}> {/* Use onSubmit on form for accessibility */}
              ...
              {error.message && (
                <p className="text-sm text-center text-error-500 mb-4">
                  {error.message}
                </p>
              )}
              <div className="space-y-6">
                <div>
                  ...
                  <Input
                    ...
                    error={error.email} // Pass error prop to Input
                  />
                  {/* Display email validation error */}
                  {error.email && (
                    <p className="text-sm text-error-500 mt-1">{error.email}</p>
                  )}
                </div>
                <div>
                  ...
                  <div className="relative">
                    <Input
                      ...
                      onChange={handleChange}
                      error={error.password} // Pass error prop to Input
                    />
                    <span
                  ...
                  {error.password && (
                    <p className="text-sm text-error-500 mt-1">{error.password}</p>
                  )}
                </div>
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    href="/reset-password"
                    className="text-sm text-black hover:text-black dark:text-gray-400 border-b-2 border-[#ffcc09] pb-[1px]"
                  >
                    Forgot password?
                  </Link>
