  ...
  return (
    <div>
      ...
      <div className="space-y-5 sm:space-y-6">
        {/* Primary Button */}
        <ComponentCard title="Primary Button" name="">
        ...
        <ComponentCard title="Primary Button with Left Icon" name="">
          <div className="flex items-center gap-5">
        ...
        {/* Primary Button with Start Icon */}
        <ComponentCard title="Primary Button with Right Icon" name="">
          <div className="flex items-center gap-5">
        ...
        {/* Outline Button */}
        <ComponentCard title="Secondary Button" name="">
          <div className="flex items-center gap-5">
            {/* Outline Button */}
        ...
        <ComponentCard title="Outline Button with Left Icon" name="">
          <div className="flex items-center gap-5">
        ...
        {/* Outline Button with Start Icon */}
        <ComponentCard title="Outline Button with Right Icon" name="">
          <div className="flex items-center gap-5">
